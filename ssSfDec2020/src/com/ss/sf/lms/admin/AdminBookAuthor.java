...
public class AdminBookAuthor {
	...
	public void addBook(Scanner console){
		...
		newBook.setTitle(console.next() + console.nextLine());
		try{
	...
	public void addAuthor(Scanner console){
		...
		newAuthor.setAuthorName(console.next() + console.nextLine());
		try{
	...
	public void updateBook(Scanner console){
		...
		try{
			...
			book.setTitle(console.next() + console.nextLine());
	...
	public void updateAuthor(Scanner console){
		...
		try{
			...
			author.setAuthorName(console.next() + console.nextLine());
